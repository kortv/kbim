...
var l,
    ...
    valid = false,
    a = "770me2rugayywp",
    fwk = "https://platform.linkedin.com/js/framework?v=0.0.1191-RC8.56339-1429",
    xtnreg = /extensions=([^&]*)&?/,
...
if AUTH_USERSPACE
  ...
  */
    l.anonymous_token = "vhPxrVutxsI1eMTloTVA7k4XbUJkwhxgOmuq";
    l.anonymous_expires_in = parseInt("1800", 10);
    l.member_id = "";
    l.api_key = "770me2rugayywp";
    l = IN.ENV.api = IN.ENV.api || {};
    l.queue_interval = parseInt("300", 10);
    l = IN.ENV.url =  IN.ENV.url || {};
    l.xd_html = "https://platform.linkedin.com/js/xdrpc.html?v=0.0.1191-RC8.56339-1429";
    l.xd_us_html = "https://platform.linkedin.com/js/xdrpc.html?v=0.0.1191-RC8.56339-1429";
    l.api_xd_html = "https://api.linkedin.com/uas/js/xdrpc.html?v=0.0.1191-RC8.56339-1429";
    ...
    l.userspace_renew = "https://www.linkedin.com/uas/js/authuserspace?v=0.0.1191-RC8.56339-1429&api_key={API_KEY}";
...
/*
  ...
  */
    ...
    l.unsecure_xdswf = "https://platform.linkedin.com/js/easyXDM.swf?v=0.0.1191-RC8.56339-1429";
    l.secure_xdswf = "https://platform.linkedin.com/js/easyXDM.swf?v=0.0.1191-RC8.56339-1429";
...
*/
  ...
  */
  ...
  var src = "https://platform.linkedin.com/js/framework?v=0.0.1191-RC8.56339-1429";
