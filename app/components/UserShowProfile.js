...
export default function UserShowProfile() {
  return (
    ...
    <div id='content'>
      <div className='container'>
        ...
        <div className='row my-designs'>
          <div className='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
            <h3>portfolio</h3>
          </div>
          <div className='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
            <div className='row item-design'>
              <div className='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                <div className='row  header-item-design'>
                  ...
                  <div className='col-lg-5 col-md-5 col-sm-6  col-xs-12 small-col'>
                    <div className='row'>
                      <div className='col-xs-3 col-lg-3 col-md-3 col-sm-3 '>
                      ...
                      <div className='col-lg-6 col-sm-6 col-md-6 col-xs-6'>
                        <a href='#' className='btn view-proposal'>Vedi proposta</a>
                      </div>
                    </div>
                  </div>
                </div>
                <div className='row property-list'>
                  <div className='col-lg-12 col-md-12 col-sm-12 col-xs-12 property-item'>
                    <p className='property-name'>ATTINENZA</p>
                  ...
                  <div className='col-lg-12 col-md-12 col-sm-12 col-xs-12 property-item'>
                    <p className='property-name'>ORIGINALITA’</p>
                    <div className='stars-wrap'>
                      <i className='fa fa-star' aria-hidden='true' />
                      <i className='fa fa-star' aria-hidden='true' />
                      <i className='fa fa-star' aria-hidden='true' />
                  ...
                  <div className='col-lg-12 col-md-12 col-sm-12 col-xs-12 property-item'>
                    <p className='property-name'>FATTIBILITA’</p>
                    <div className='stars-wrap'>
                      <i className='fa fa-star' aria-hidden='true' />
                      <i className='fa fa-star' aria-hidden='true' />
                      <i className='fa fa-star' aria-hidden='true' />
                  ...
                  <div className='col-lg-12 col-md-12 col-sm-12 col-xs-12 property-item'>
                    <p className='property-name'>PRESENTAZIONE</p>
                    <div className='stars-wrap'>
                      <i className='fa fa-star' aria-hidden='true' />
                      <i className='fa fa-star' aria-hidden='true' />
                      <i className='fa fa-star' aria-hidden='true' />
